...
async def create_user(email: str = Form(...),
                      ...
                      picture: UploadFile = File(default=None),  # fixme check image form field in react app
    ...
    if db_user:
        raise HTTPException(status_code=status.HTTP_422_UNPROCESSABLE_ENTITY, detail="Phone already registered")
